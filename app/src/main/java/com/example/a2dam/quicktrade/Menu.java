...
public class Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarios = (Button) findViewById(R.id.btn_menu_users);
        usuarios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Menu.this, Usuarios.class);
                startActivity(i);
            }
        });

        seguidores = (Button) findViewById(R.id.btn_menu_seguidos);
        seguidores.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Menu.this, MisSeguidores.class);
                startActivity(i);
            }
        });
    }
